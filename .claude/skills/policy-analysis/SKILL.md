...
- **章节标题**: 看政策
- **核心数据点**:
  - 2025政府工作报告明确"着力提振消费，全方位扩大内需需求"
  - 2025年2月《优化消费环境三年行动方案(2025—2027)》五大行动
  - 2025年3月《提振消费专项行动方案》
  - 三大运营商2025Q1营收增速接近0%，中石化-6.9%，中国中免-10.96%
  - 客户消费从"量的消费"→"质的消费"→"体验消费"三阶段演进
...
**通过 `/learn-policy-analysis` 触发**

执行步骤:
1. 扫描 `news/` 目录，读取所有 `.md` 文件
2. 按关键词评分相关性，关键词: 政策,内需,工作报告,消费,监管,央企
...
（由 `/learn-policy-analysis` 从 `news/` 目录填充，初始为空）
