...
description: >
  TRIGGER when user invokes /industry-analysis or asks to analyze or write the 看行业 section
  of a Chinese business plan. Produces Chinese PPT-ready content as a senior SOE manager.
  Supports --style=<name> override.
---

# industry-analysis: 看行业 专家技能
...
- **核心数据点** (数智生活商城参考示例 — 替换为您项目的数据):
  - DoCoMo：d POINT CLUB超1亿会员，2024财年合作商户积分使用额约2,736亿日元(约132.6亿元人民币)
  - DoCoMo：金融支付交易额(含d卡/iD/d扫码等)14.98万亿日元(约7270亿元人民币)
  - SKT：T Universe月活超260万，2024年商品交易总额超1.3万亿韩元(约67亿元人民币)
  - 招行掌上生活APP：1.44亿累计用户，4197万活跃用户，连接近3万品牌、16万商户
  - 成功要素：以支付为载体，积分当"现金"，高频场景(便利店/出行/外卖)
...
**通过 `/learn-industry-analysis` 触发**

执行步骤:
1. 扫描 `news/` 目录，读取所有 `.md` 文件
2. 按关键词评分相关性，关键词: 运营商,竞争,行业,DoCoMo,SKT,招商银行,会员制,积分,权益
...
（由 `/learn-industry-analysis` 从 `news/` 目录填充，初始为空）
