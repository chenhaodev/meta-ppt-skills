...
name: kpi
description: >
  TRIGGER when user invokes /kpi or asks to analyze or write the 计收政策、考核政策 section
...
- **章节标题**: 计收政策、考核政策
- **核心数据点**:
  - 计收政策：在现有差额计通服收入基础上，实现全额计营运收入及全额计通服收入
  - 省专计收规则：商城所有收入均计入省公司；主体运营单位根据支撑成本和运营成效获运营支撑费
  - 考核原则：以集团利益最大化为原则，促进责权利匹配和管理同向，开展"省专同考"
  - 省公司考核：会员用户规模、商城收入、会员活跃、属地商户拓展数量/有交易量商户占比
  - 主体运营单位考核：商城收入、商城活跃用户、商城流量价值、商户拓展数量/有交易量商户占比
...
2. 按关键词评分相关性，关键词: 考核,KPI,指标,绩效,计收,省专同考,营运收入
