...
- **章节标题**: 商城概览
- **核心数据点**:
  - 数智生活商城是公司打造的全场景数智生活服务平台，以中国移动APP为核心
  - 整合基础通信、数字生活、智慧家庭、企业服务等多元业态
  - 覆盖"衣食住行医教娱养"等民生及政企服务领域
  - 核心卖点1：数字化服务(通信/互联网会员/5G特色应用)
  - 核心卖点2：智能化服务(人车家/智能家居/健康生活)
  - 核心卖点3：本地生活(周边生活/产地直供/一省一特色)
  - 目标：规模最大、品类最全、体验最优的数智生活商城
...
**通过 `/learn-overview` 触发**

执行步骤:
1. 扫描 `news/` 目录，读取所有 `.md` 文件
2. 按关键词评分相关性，关键词: 数智生活商城,概览,全场景,定义,定位,APP,移动
...
（由 `/learn-overview` 从 `news/` 目录填充，初始为空）
