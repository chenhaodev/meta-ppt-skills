...
name: future-goals
description: >
  TRIGGER when user invokes /future-goals or asks to analyze or write the 2025-2027年发展目标 section
  of a Chinese business plan. Produces Chinese PPT-ready content as a senior SOE manager.
  Supports --style=<name> override.
---

# future-goals: 2025-2027年发展目标 专家技能
...
- **核心数据点** (数智生活商城参考示例 — 替换为您项目的数据):
  - 收入目标：2025年318亿 → 2026年400亿 → 2027年500亿
  - 用户规模：2025年3亿 → 2026年4亿 → 2027年5亿
  - 投入产出：2025-2027年平均业务收入406亿/年，平均成本332.2亿/年，平均利润73.8亿/年，利润率18.2%
  - 平台研发费：2026年9385万元/年
  - 总部统筹业务支撑费：2026年10亿元/年
  - 战略目标：三年月活破亿；五年年收入破千亿，成为公司增长新引擎；推动子公司独立拆分上市，拉动母公司资本市场估值提升超千亿
...
**通过 `/learn-future-goals` 触发**

执行步骤:
1. 扫描 `news/` 目录，读取所有 `.md` 文件
2. 按关键词评分相关性，关键词: 目标,收入,用户规模,发展目标,千亿,战略,拆分上市
...
（由 `/learn-future-goals` 从 `news/` 目录填充，初始为空）
