...
- **章节标题**: 组织架构
- **核心数据点**:
  - 集团公司：设数智生活商城工作专班，张冬副总经理担任组长
  - 在线公司：下设"数智生活事业群"(一级副运营机构)，负责全网统一权益产品开发/推广/运营
  - 金科公司：下设"支付生态事业群"(一级副运营机构)，负责混合支付/购物车合并付款等支付能力
  - 省公司：增设数智生活运营中心(二级副运营机构)，2025年底配置20-30人，2026年底30-60人
  - 地市公司：设数智生活商城运营专班，配置3-6个专职人员
  - 县公司：在市场部下设数智生活运营组，配置2-3个专职人员
...
**通过 `/learn-org-structure` 触发**

执行步骤:
1. 扫描 `news/` 目录，读取所有 `.md` 文件
2. 按关键词评分相关性，关键词: 组织,架构,集团,省公司,专班,事业群,运营中心,在线公司,金科
...
（由 `/learn-org-structure` 从 `news/` 目录填充，初始为空）
